        ...
        <PublicUserHomeLayout>
                                            ...
                                            <div key={index} className="row border border-secondary rounded mb-4 mx-1 p-2">
                                                <div className="col-md-5">
                                                    <NavLink to={`/ReadBloog/BloogID/${PostItem._id}`}>
                                                        <img onClick={handleClick} style={{ width: "100%" }} src={PostItem.PostThumbnail} className='img-fluid rounded' alt="" />
                                                    </NavLink>
                                                ...
                                                <div className="col-md-7">
                                                    <NavLink to={`/ReadBloog/BloogID/${PostItem._id}`} style={{ cursor: "pointer" }}>
                                                        <h2 onClick={handleClick} className='CommonColor fs-4'>{PostItem.PostTitle}</h2>
                                                        <div  onClick={handleClick} className="text-muted">
                                                            <div dangerouslySetInnerHTML={{ __html: PostItem.PostDetails.substring(0, 50) + ". see more..." }}></div>
                                                        </div>
                                                    </NavLink>
                                                    <NavLink  onClick={handleClick} to={`/ReadBloog/BloogID/${PostItem._id}`} style={{ cursor: "pointer" }}>
            ...
            <div className="row mt-4">
                ...
                <div className="col-md-8">
                    ...
                    <PublicPostPaginationComponents PostPaginationDataLimit={10} />
                    {/* Post Overview Post Details info end */}
                    ...
                    <PublicCategoryPaginationComponents CategoryPaginationDataLimit={10} />
...
export default PublicReadBloog;