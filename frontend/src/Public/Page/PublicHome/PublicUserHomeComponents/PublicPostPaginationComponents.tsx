...
const PublicPostPaginationComponents: React.FC<PostPaginationProps> = ({ PostPaginationDataLimit }) => {
    ...
    const PostPagination = async (pageNo: number, perPage: number, searchKeyword: string) => {
        return axios.get(`http://localhost:5000/api/v1/PostPagination/${pageNo}/${perPage}/${searchKeyword}`);
    };
...
export default PublicPostPaginationComponents;
