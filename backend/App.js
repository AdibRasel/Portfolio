...
// ====================== start প্রতি ১ মিনিট পর পর নিচের ফাংশন কল হবে। ========================

// প্রতি 1 মিনিট পর পর ১ মাস বা ১ বছরের মেয়াদ শেষ হওয়া সার্ভিস নিষ্ক্রিয় করুন
cron.schedule("*/1 * * * *", async () => {  // প্রতি 1 মিনিট পর পর
...
// ====================== end প্রতি ১ মিনিট পর পর নিচের ফাংশন কল হবে। ========================
